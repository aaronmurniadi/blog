// Vendored from Prism v1.30.0 (https://prismjs.com) - core + python + bash concatenated in dependency order.
// Sources: cdnjs prism/1.30.0 prism.min.js, components/prism-python.min.js, components/prism-bash.min.js
// Plus Typst support from Mc-Zen/prism-typst (MIT, Copyright (c) 2024-2025 Mc-Zen), appended at the end.
...
// Typst language definition vendored from Mc-Zen/prism-typst (MIT License, Copyright (c) 2024-2025 Mc-Zen).
// Source: https://github.com/Mc-Zen/prism-typst/blob/master/src/prism-typst.js
// Registers Prism.languages.typst (aliases: typ, typc, typst-code). Load order: after Prism core.
